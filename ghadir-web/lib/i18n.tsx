...
const en: T = {
  ...
  country_help: "Used to show causes near you first.",
...
const ar: T = {
  ...
  country_help: "تُستخدم لعرض القضايا القريبة منك أولاً.",
  in_your_country: "في دولتك",
...
const fa: T = {
  ...
  country_help: "برای نمایش ابتدا اهداف نزدیک شما استفاده می‌شود.",
  in_your_country: "در کشور شما",
...
const ur: T = {
  ...
  country_help: "آپ کے قریب مقاصد پہلے دکھانے کے لیے استعمال ہوتا ہے۔",
  in_your_country: "آپ کے ملک میں",
