...
insert into campaigns (name, type, status, description, start_date, end_date, target_usd, raised_usd, platform) values
...
(
  ...
  '2026-05-01', '2026-08-25', 5000, 2150, 'multiple'
),
...
(
  ...
  '2026-05-15', '2026-06-30', null, 0, 'telegram'
),
...
(
  ...
  '2026-07-12', '2026-07-12', null, 0, 'instagram'
),
...
(
  ...
  '2026-04-01', '2026-09-30', 10000, 3400, 'website'
),
...
(
  ...
  '2026-03-01', '2026-03-30', 2000, 1875, 'telegram'
);
